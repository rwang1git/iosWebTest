...
- (void)wm_setup {
    ...
    _titleColorSelected = [UIColor colorWithRed:0 green:20.0/255.0 blue:255.0 alpha:1];
...
- (void)wm_calculateSize {
    if ([self.dataSource respondsToSelector:@selector(pageController:preferredFrameForMenuView:)]) {
        ...
        _menuViewFrame = CGRectMake(0, originY+20, self.view.frame.size.width, 30.0f); //towa
    }
...
- (void)wm_adjustMenuViewFrame {
    ...
    self.menuView.backgroundColor = [UIColor blueColor]; // towa
